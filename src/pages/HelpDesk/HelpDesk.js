                ...
                <Row>
                    <Col lg={2} className="mt-3">
                        <Stack>
                            ...
                            <Button style={{ marginBottom: '10px' }} id='help-btn' variant="outline-secondary" onClick={handleShow}>
                            ...
                            <Button style={{ marginBottom: '10px' }} variant="outline-primary" onClick={handleShow}>
                            ...
                            <Button style={{ marginBottom: '10px' }} id='help-btn' variant="outline-danger" onClick={handleShow}>
                                <AiFillBug style={{ marginRight: '5px' }} />
                                Bug Report
                            </Button>
                            <Button style={{ marginBottom: '10px' }} id='help-btn' variant="outline-warning" onClick={handleShow}>
                                <FaExchangeAlt style={{ marginRight: '5px' }} />
                                Change Request
                            </Button>
                            <Button style={{ marginBottom: '10px' }} id='help-btn' variant="outline-info" onClick={handleShow}>
